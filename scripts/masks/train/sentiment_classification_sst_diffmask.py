...
class BertSentimentClassificationSSTDiffMask(
    ...
    def forward_explainer(
        ...
        logits_orig = torch.tensor([1., 0., 0., 0., 0.], device=logits_orig.device).repeat(logits_orig.size(0)).view(-1, logits_orig.size(1)) # TODO: DEBUG: Remove this later
